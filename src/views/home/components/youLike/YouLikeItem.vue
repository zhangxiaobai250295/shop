...
<!--          <img class="image" :src="youLikeItemData.small_image" :alt="youLikeItemData.name">-->
          <van-image :src="youLikeItemData.small_image">
      ...
      <div class="infoWrapper">
        <div class="name">
          <span class="nameText">{{youLikeItemData.name}}</span>
        </div>
        ...
        <div class="priceWrapper">
          <div class="priceInfo">
            <div class="pricePart">
              <div class="price">
                {{youLikeItemData.price | moneyFormat}}
              </div>
