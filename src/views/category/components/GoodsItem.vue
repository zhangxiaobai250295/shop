...
<!--          <img class="image" src="https://img.ddimg.mobi/product/46825eb5225721559303701220.jpg!deliver.product.list?imageMogr2/thumbnail/120x120" alt=""></div>-->
<!--      </div>-->
<!--      <div class="infoWrapper">-->
<!--        <div class="nameWrapper">-->
<!--          <div class="name">-->
<!--            <span class="nameTag nameText">味全严选牧场牛奶 950ml/瓶</span>-->
<!--          </div>-->
<!--          <div class="spec">-->
<!--            新老包装交替发货~严选牧场牛奶，把新鲜送到你家-->
<!--          </div>-->
...
<!--  </div>-->
  <div class="productWrapper">
    <div v-for="(product, index) in goodsData" class="infoWrapper">
      <div class="imageWrapper">
        <div class="LazyLoad is-visible">
